...
Public Class rptClientesPais
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CAPA_PRESENTACION.rptClientesPais.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptClientesPais
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptClientesPais = New rptClientesPais()
        rpt.Site = Me.Site
        Return rpt
    End Function
